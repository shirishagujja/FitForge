...
Revision ID: 002_email_password_tokens
...
revision: str = "002_email_password_tokens"
...
def downgrade() -> None:
    ...
    op.drop_index("ix_email_verify_expires", table_name="email_verification_tokens")
